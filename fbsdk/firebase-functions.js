  ...
  try {
      (function () {
          ...
          var a =
              ((n.prototype.create = function (e) {
                  ...
                  for (
                      ...
                      var p = f[l];
                      "_" !== p.slice(-1) && (p in c && console.warn('Overwriting FirebaseError base field "' + p + '" can cause unexpected behavior.'), (c[p] = i[p]));
                  }
                  return c;
              }),
              n);
          ...
          function f(e, t, n) {
              ...
              return Object.setPrototypeOf(r, f.prototype), (r.code = e), (r.details = n), r;
          }
          function g(e, t, n) {
              var r = (function (e) {
              ...
              try {
                  ...
                  if (a) {
                      var s = a.status;
                      if ("string" == typeof s) {
                          if (!l[s]) return new y("internal", "internal");
                          (r = l[s]), (i = s);
                      }
                      var u = a.message;
              ...
              return "ok" === r ? null : new y(r, i, o);
          }
          var p =
              ((b.prototype.getAuthToken = function () {
              ...
              (b.prototype.getInstanceIdToken = function () {
                  return t(this, void 0, void 0, function () {
                      return d(this, function (e) {
                  ...
                  return t(this, void 0, void 0, function () {
                      ...
                      return d(this, function (e) {
                          switch (e.label) {
                              ...
                              case 2:
                                  return (n = e.sent()), [2, { authToken: t, instanceIdToken: n }];
                          }
                      });
                  });
              }),
          ...
          var N =
              ...
              (O.prototype._url = function (e) {
                  var t = this.app_.options.projectId,
                      n = this.region_;
                  return null === this.emulatorOrigin ? "https://" + n + "-" + t + ".cloudfunctions.net/" + e : this.emulatorOrigin + "/" + t + "/" + n + "/" + e;
              }),
              (O.prototype.useFunctionsEmulator = function (e) {
                  this.emulatorOrigin = e;
              }),
              (O.prototype.httpsCallable = function (t, n) {
                  var r = this;
                  return function (e) {
                      return r.call(t, e, n || {});
                  };
              }),
              (O.prototype.postJSON = function (r, i, o) {
                  return t(this, void 0, void 0, function () {
                      var t, n;
                      return d(this, function (e) {
                          switch (e.label) {
                              case 0:
                                  o.append("Content-Type", "application/json"), (e.label = 1);
                              case 1:
                                  return e.trys.push([1, 3, , 4]), [4, fetch(r, { method: "POST", body: JSON.stringify(i), headers: o })];
                              case 2:
                                  return (t = e.sent()), [3, 4];
                              case 3:
              ...
              (O.prototype.call = function (l, f, p) {
                  return t(this, void 0, void 0, function () {
                      var t, r, i, o, a, s, u, c;
                      return d(this, function (e) {
                          switch (e.label) {
                              case 0:
                                  return (t = this._url(l)), (f = this.serializer.encode(f)), (r = { data: f }), (i = new Headers()), [4, this.contextProvider.getContext()];
                              case 1:
                                  return (
                                      (o = e.sent()).authToken && i.append("Authorization", "Bearer " + o.authToken),
                                      o.instanceIdToken && i.append("Firebase-Instance-ID-Token", o.instanceIdToken),
                                      (a = p.timeout || 7e4),
                                      [
                                          4,
                                          Promise.race([
                                              ...
                                              new Promise(function (e, t) {
                                                  setTimeout(function () {
                                                      t(new y("deadline-exceeded", "deadline-exceeded"));
                                                  }, n);
                                              })),
                              ...
                              case 2:
                                  if (!(s = e.sent())) throw new y("cancelled", "Firebase Functions instance was deleted.");
                                  if ((u = g(s.status, s.json, this.serializer))) throw u;
                                  if (!s.json) throw new y("internal", "Response is not valid JSON object.");
                                  if ((void 0 === (c = s.json.data) && (c = s.json.result), void 0 === c)) throw new y("internal", "Response is missing data field.");
                                  return [2, { data: this.serializer.decode(c) }];
                          }
                          var n;
                      });
                  });
          ...
          function O(e, t, n, r) {
              ...
              void 0 === r && (r = "us-central1"),
                  ...
                  (this.contextProvider = new p(t, n)),
          ...
          function I(e, t) {
              ...
              return new N(n, r, i, t);
          }
          var T;
          (T = { Functions: N }), A.INTERNAL.registerComponent(new s("functions", I, "PUBLIC").setServiceProps(T).setMultipleInstances(!0)), A.registerVersion("@firebase/functions", "0.4.43");
      }.apply(this, arguments));
  } catch (e) {
      throw (console.error(e), new Error("Cannot instantiate firebase-functions.js - be sure to load firebase-app.js first."));
  }
});
