!(function (t, e) {
  ...
  try {
      (function () {
          (Xl = Xl && Object.prototype.hasOwnProperty.call(Xl, "default") ? Xl.default : Xl),
              function () {
                  var t,
                      o =
                  ...
                  !(function (t, e) {
                      ...
                      return (
                          ...
                          (s.race = function (r) {
                              return new s(function (t, e) {
                                  for (var n = c(r), i = n.next(); !i.done; i = n.next()) u(i.value).Oa(t, e);
                              });
                          }),
                          (s.all = function (t) {
                              var o = c(t),
                              ...
                              return a.done
                                  ...
                                  : new s(function (n, t) {
                                        ...
                                        for (var i = [], r = 0; i.push(void 0), r++, u(a.value).Oa(e(i.length - 1), t), !(a = o.next()).done; );
                                    });
                          }),
                          s
                      );
                  ...
                  var E,
                      ...
                      S = {
                          ...
                          pd: { Ra: "https://www.googleapis.com/identitytoolkit/v3/relyingparty/", Xa: "https://securetoken.googleapis.com/v1/token", Ua: "https://identitytoolkit.googleapis.com/v2/", id: "p" },
                          rd: {
                  ...
                  function N(t) {
                      for (var e in S) if (S[e].id === t) return { firebaseEndpoint: (t = S[e]).Ra, secureTokenEndpoint: t.Xa, identityPlatformEndpoint: t.Ua };
                      return null;
                  }
                  function _(t) {
                      if (t)
                  ...
                  var V = Array.prototype.filter
                      ...
                      q = Array.prototype.some
                          ...
                          : function (t, e) {
                                for (var n = t.length, i = "string" == typeof t ? t.split("") : t, r = 0; r < n; r++) if (r in i && e.call(void 0, i[r], r, t)) return !0;
                                return !1;
                            };
                  function H(t, e) {
                      return 0 <= j(t, e);
                  ...
                  t: {
                      var Jt = "",
                          Yt =
                              ((Ft = X),
                              Bt ? /rv:([^\);]+)(\)|;)/.exec(Ft) : Kt ? /Edge\/([\d\.]+)/.exec(Ft) : Ht ? /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(Ft) : Wt ? /WebKit\/(\S+)/.exec(Ft) : qt ? /(?:Version)[ \/]?(\S+)/.exec(Ft) : void 0);
                      if ((Yt && (Jt = Yt ? Yt[1] : ""), Ht)) {
                          var zt = Xt();
                  ...
                  function ae(t, e, n) {
                      ...
                      if (!te && a && (a.name || a.type)) {
                          if (((o = ["<", o]), a.name && o.push(' name="', jt(a.name), '"'), a.type)) {
                      ...
                      return (
                          (o = se(r, o)),
                          a && ("string" == typeof a ? (o.className = a) : Array.isArray(a) ? (o.className = a.join(" ")) : ne(o, a)),
                          2 < i.length &&
                              (function (e, n, t) {
                                  function i(t) {
                                  ...
                                  for (var r = 2; r < t.length; r++) {
                                      var o = t[r];
                                      !h(o) || (v(o) && 0 < o.nodeType) ? i(o) : U(ue(o) ? W(o) : o, i);
                                  }
                              })(r, o, i),
                          o
                      );
                      ...
                      re ||
                          (function () {
                              if (l.Promise && l.Promise.resolve) {
                                  ...
                                  re = function () {
                                      var t = pe;
                                      !p(l.setImmediate) || (l.Window && l.Window.prototype && !at("Edge") && l.Window.prototype.setImmediate == l.setImmediate) ? (ie = ie || he())(t) : l.setImmediate(t);
                                  };
                          })(),
                          fe || (re(), (fe = !0)),
                          de.add(t, e);
                  ...
                  function ve(t, e) {
                      if (((this.a = me), (this.i = void 0), (this.f = this.b = this.c = null), (this.g = this.h = !1), t != s))
                          try {
                              var n = this;
                              t.call(
                                  e,
                          ...
                          if (r)
                              for (
                                  var t = function (t, e, n) {
                                          r--, (o[t] = e ? { Mb: !0, value: n } : { Mb: !1, reason: n }), 0 == r && i(o);
                                      },
                                      e = 0;
                                  e < n.length;
                                  e++
                  ...
                  function Se(t, e) {
                      t.b || (t.a != ge && t.a != be) || Re(t), t.f ? (t.f.next = e) : (t.b = e), (t.f = e);
                  }
                  function Ne(t, r, o, a) {
                  ...
                  function _e(t, e, n) {
                      var i, r;
                      t.a == me &&
                          (t === n && ((e = be), (n = new TypeError("Promise cannot resolve to itself"))),
                          (t.a = 1),
                          Oe(n, t.Yc, t.Zc, t) ||
                              ((t.i = n),
                              (t.a = e),
                                      ...
                                      if (e.a == me)
                                          if (e.c) {
                                              ...
                                              if (i.b) {
                                                  ...
                                                  o && (i.a == me && 1 == r ? t(i, n) : (a ? ((r = a).next == i.f && (i.f = r), (r.next = r.next.next)) : Ce(i), De(i, o, be, n)));
                                              }
                                              e.c = null;
                                          } else _e(e, be, n);
                                  })(this, e);
                  ...
                  var je = 0;
                  function Ue(t) {
                      if (!t.wa && ((t.wa = !0), t.Ba(), 0 != je)) (e = t), (Object.prototype.hasOwnProperty.call(e, i) && e[i]) || (e[i] = ++r);
                      var e;
                  }
                  ...
                  function Ge(t, e) {
                      if (
                          ...
                          (this.relatedTarget = e),
                              i
                                  ? ((this.clientX = void 0 !== i.clientX ? i.clientX : i.pageX), (this.clientY = void 0 !== i.clientY ? i.clientY : i.pageY), (this.screenX = i.screenX || 0), (this.screenY = i.screenY || 0))
                              ...
                              (this.pointerType = "string" == typeof t.pointerType ? t.pointerType : Be[t.pointerType] || ""),
                  ...
                  function Je(t, e, n, i, r) {
                      (this.listener = t), (this.proxy = null), (this.src = e), (this.type = n), (this.capture = !!i), (this.Ta = r), (this.key = ++Xe), (this.ua = this.Na = !1);
                  }
                  function Ye(t) {
                  ...
                  function $e(t, e) {
                      var n = e.type;
                      n in t.a && K(t.a[n], e) && (Ye(e), 0 == t.a[n].length && (delete t.a[n], t.b--));
                  }
                  function Ze(t, e, n, i) {
                  ...
                  ze.prototype.add = function (t, e, n, i, r) {
                      ...
                      var a = Ze(t, e, i, r);
                      return -1 < a ? ((e = t[a]), n || (e.Na = !1)) : (((e = new Je(e, this.src, o, !!i, r)).Na = n), t.push(e)), e;
                  };
                  var Qe = "closure_lm_" + ((1e6 * Math.random()) | 0),
                      tn = {};
                  function en(t, e, n, i, r) {
                      if (i && i.once) rn(t, e, n, i, r);
                      else if (Array.isArray(e)) for (var o = 0; o < e.length; o++) en(t, e[o], n, i, r);
                      else (n = dn(n)), t && t[We] ? vn(t, e, n, v(i) ? !!i.capture : !!i, r) : nn(t, e, n, !1, i, r);
                  }
                  function nn(t, e, n, i, r, o) {
                      ...
                      var a,
                          ...
                          u = v(r) ? !!r.capture : !!r,
                          c = ln(t);
                      if ((c || (t[Qe] = c = new ze(t)), !(n = c.add(e, n, i, u, o)).proxy))
                          if (
                              ((a = hn),
                              (i = s = Fe
                                  ? function (t) {
                              ...
                              He || (r = u), void 0 === r && (r = !1), t.addEventListener(e.toString(), i, r);
                  ...
                  function rn(t, e, n, i, r) {
                      if (Array.isArray(e)) for (var o = 0; o < e.length; o++) rn(t, e[o], n, i, r);
                      else (n = dn(n)), t && t[We] ? mn(t, e, n, v(i) ? !!i.capture : !!i, r) : nn(t, e, n, !0, i, r);
                  }
                  function on(t, e, n, i, r) {
                      if (Array.isArray(e)) for (var o = 0; o < e.length; o++) on(t, e[o], n, i, r);
                      else
                          (i = v(i) ? !!i.capture : !!i),
                              (n = dn(n)),
                              t && t[We]
                                  ? ((t = t.u), (e = String(e).toString()) in t.a && -1 < (n = Ze((o = t.a[e]), n, i, r)) && (Ye(o[n]), Array.prototype.splice.call(o, n, 1), 0 == o.length && (delete t.a[e], t.b--)))
                                  : (t = t && ln(t)) && ((e = t.a[e.toString()]), (t = -1), e && (t = Ze(e, n, i, r)), (n = -1 < t ? e[t] : null) && an(n));
                  }
                  function an(t) {
                      if ("number" != typeof t && t && !t.ua) {
                          ...
                          if (e && e[We]) $e(e.u, t);
                              ...
                              var n = t.type,
                                  i = t.proxy;
                              e.removeEventListener ? e.removeEventListener(n, i, t.capture) : e.detachEvent ? e.detachEvent(sn(n), i) : e.addListener && e.removeListener && e.removeListener(i),
                                  (n = ln(e)) ? ($e(n, t), 0 == n.b && ((n.src = null), (e[Qe] = null))) : Ye(t);
                          }
                      }
                  }
                  function sn(t) {
                  ...
                  function un(t, e, n, i) {
                      ...
                      if ((t = ln(t)) && (e = t.a[e.toString()]))
                          for (e = e.concat(), t = 0; t < e.length; t++) {
                              var o = e[t];
                              o && o.capture == n && !o.ua && ((o = cn(o, i)), (r = r && !1 !== o));
                          }
                      return r;
                  }
                  function cn(t, e) {
                  ...
                  function hn(t, e) {
                      ...
                      if (((e = new Ge((i = e), this)), (n = !0), !(i.keyCode < 0 || null != i.returnValue))) {
                          t: {
                              var r = !1;
                              if (0 == i.keyCode)
                                  try {
                          ...
                          for (r = 0; r < i.length; r++) (e.b = i[r]), (o = un(i[r], t, !1, e)), (n = n && o);
                      }
                      return n;
                  }
                  function ln(t) {
                  ...
                  function Tn(t, e) {
                      ...
                      if (1 < n) {
                          ...
                          if (t instanceof Tn) for (n = t.X(), i = 0; i < n.length; i++) this.set(n[i], t.get(n[i]));
                  ...
                  function En(t) {
                      ...
                      if (t.c != t.a.length) {
                          var r = {};
                          for (n = e = 0; e < t.a.length; ) An(r, (i = t.a[e])) || (r[(t.a[n++] = i)] = 1), e++;
                          t.a.length = n;
                      }
                  }
                  function An(t, e) {
                  ...
                  e(pn, xe),
                      ...
                      (pn.prototype.dispatchEvent = function (t) {
                          ...
                          if (((r = gn((a = t.b = n), i, !0, t) && r), (r = gn(a, i, !1, t) && r), e)) for (o = 0; o < e.length; o++) r = gn((a = t.b = e[o]), i, !1, t) && r;
                          return r;
                      }),
                  ...
                  function Sn(t, e) {
                      ...
                      (this.b = this.i = this.f = ""),
                          ...
                          (this.h = !1),
                          t instanceof Sn
                              ? ((this.h = void 0 !== e ? e : t.h), Nn(this, t.f), (this.i = t.i), (this.b = t.b), _n(this, t.l), (this.c = t.c), On(this, Jn(t.a)), (this.g = t.g))
                              : t && (n = String(t).match(kn))
                              ? ((this.h = !!e), Nn(this, n[1] || "", !0), (this.i = Ln(n[2] || "")), (this.b = Ln(n[3] || "", !0)), _n(this, n[4]), (this.c = Ln(n[5] || "", !0)), On(this, n[6] || "", !0), (this.g = Ln(n[7] || "")))
                  ...
                  function Mn(t, e, n) {
                      return "string" == typeof t ? ((t = encodeURI(t).replace(e, xn)), n && (t = t.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), t) : null;
                  }
                  function xn(t) {
                  ...
                  (Sn.prototype.toString = function () {
                      ...
                      var n = this.b;
                      return (
                          (!n && "file" != e) || (t.push("//"), (e = this.i) && t.push(Mn(e, jn, !0), "@"), t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), null != (n = this.l) && t.push(":", String(n))),
                          (n = this.c) && (this.b && "/" != n.charAt(0) && t.push("/"), t.push(Mn(n, "/" == n.charAt(0) ? Vn : Un, !0))),
                      ...
                      (Sn.prototype.resolve = function (t) {
                          ...
                          return n ? (e.c = i) : (n = "" !== t.a.toString()), n ? On(e, Jn(t.a)) : (n = !!t.g), n && (e.g = t.g), e;
                      });
                  var jn = /[#\/\?@]/g,
                      Un = /[#\?:]/g,
                      Vn = /[#\?]/g,
                  ...
                  function Bn(t, e) {
                      Kn(t), (e = Yn(t, e)), An(t.a.b, e) && ((t.c = null), (t.b -= t.a.get(e).length), An((t = t.a).b, e) && (delete t.b[e], t.c--, t.a.length > 2 * t.c && En(t)));
                  }
                  function Wn(t, e) {
                      return Kn(t), (e = Yn(t, e)), An(t.a.b, e);
                  }
                  function Xn(t, e, n) {
                      Bn(t, e), 0 < n.length && ((t.c = null), t.a.set(Yn(t, e), W(n)), (t.b += n.length));
                  }
                  function Jn(t) {
                      var e = new Hn();
                              ...
                              if (null == n) i.push("null");
                                  ...
                                  if ("object" == typeof n) {
                                      ...
                                      if (!(n instanceof String || n instanceof Number || n instanceof Boolean)) {
                                          for (r in (i.push("{"), (o = ""), n)) Object.prototype.hasOwnProperty.call(n, r) && "function" != typeof (a = n[r]) && (i.push(o), ti(r, i), i.push(":"), t(e, a, i), (o = ","));
                                          return void i.push("}");
                                      }
                                      n = n.valueOf();
                                  }
                  ...
                  ((t = Hn.prototype).add = function (t, e) {
                      ...
                      (t.X = function () {
                          Kn(this);
                          for (var t = this.a.V(), e = this.a.X(), n = [], i = 0; i < e.length; i++) for (var r = t[i], o = 0; o < r.length; o++) n.push(e[i]);
                          return n;
                      }),
                      (t.V = function (t) {
                          Kn(this);
                          var e = [];
                          if ("string" == typeof t) Wn(this, t) && (e = B(e, this.a.get(Yn(this, t))));
                          else {
                              t = this.a.V();
                      ...
                      (t.set = function (t, e) {
                          return Kn(this), (this.c = null), Wn(this, (t = Yn(this, t))) && (this.b -= this.a.get(t).length), this.a.set(t, [e]), (this.b += 1), this;
                      }),
                      (t.get = function (t, e) {
                  ...
                  function ti(t, e) {
                      e.push(
                          ...
                          t.replace(Qn, function (t) {
                              var e = Zn[t];
                              return e || ((e = "\\u" + (65536 | t.charCodeAt(0)).toString(16).substr(1)), (Zn[t] = e)), e;
                          }),
                          '"'
                      );
                  }
                  ...
                  function ri(t) {
                      return !!((t = (t || wi()).toLowerCase()).match(/android/) || t.match(/webos/) || t.match(/iphone|ipad|ipod/) || t.match(/blackberry/) || t.match(/windows phone/) || t.match(/iemobile/));
                  }
                  function oi(t) {
                      t = t || l.window;
                      try {
                  ...
                  function ai(t, e, n) {
                      ...
                      for (a in ((e = { width: e, height: n, top: 0 < r ? r : 0, left: 0 < o ? o : 0, location: !0, resizable: !0, statusbar: !0, toolbar: !1 }),
                      (n = wi().toLowerCase()),
                      i && ((e.target = i), nt(n, "crios/") && (e.target = "_blank")),
                      gi(wi()) == vi && ((t = t || "http://localhost"), (e.scrollbars = !0)),
                      (n = t || ""),
                      (t = e) || (t = {}),
                      (i = window),
                      (e = n instanceof kt ? n : _t(void 0 !== n.href ? n.href : String(n))),
                      (n = t.target || n.target),
                      (r = []),
                      t))
                          switch (a) {
                      ...
                      var a = r.join(",");
                      if (
                          (((at("iPhone") && !at("iPod") && !at("iPad")) || at("iPad") || at("iPod")) && i.navigator && i.navigator.standalone && n && "_self" != n
                              ? (ft((a = se(document, "A")), "HTMLAnchorElement"),
                                e instanceof kt || e instanceof kt || ((e = "object" == typeof e && e.ra ? e.qa() : String(e)), Nt.test(e) || (e = "about:invalid#zClosurez"), (e = new kt(Rt, e))),
                                (a.href = St(e)),
                              ...
                              ? ((a = i.open("", n, a)),
                                (t = St(e)),
                                a &&
                                    (Gt && nt(t, ";") && (t = "'" + t.replace(/'/g, "%27") + "'"),
                                    (a.opener = null),
                                    (t = Lt('<meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0; url=' + jt(t) + '">')),
                                    (i = a.document)) &&
                  ...
                  function hi(t) {
                      return (t = t || wi()), !(("file:" !== ki() && "ionic:" !== ki()) || !t.toLowerCase().match(/iphone|ipad|ipod|android/));
                  }
                  function li() {
                      var t = l.window;
                      try {
                  ...
                  function di() {
                      return Xl.INTERNAL.hasOwnProperty("reactNative") ? "ReactNative" : Xl.INTERNAL.hasOwnProperty("node") ? "Node" : fi() ? "Worker" : "Browser";
                  }
                  function pi() {
                      var t = di();
                  ...
                  function gi(t) {
                      ...
                      return nt(e, "opera/") || nt(e, "opr/") || nt(e, "opios/")
                          ...
                          : nt(e, "webos")
                          ? "Webos"
                          : !nt(e, "safari/") || nt(e, "chrome/") || nt(e, "crios/") || nt(e, "android")
                  ...
                  function yi(t, e) {
                      ...
                      return i.sort(), (e = i).length || (e = ["FirebaseCore-web"]), "Browser" === (i = di()) ? (i = gi((r = wi()))) : "Worker" === i && (i = gi((r = wi())) + "-" + i), i + "/JsCore/" + t + "/" + e.join(",");
                  }
                  function wi() {
                  ...
                  function Ti() {
                      try {
                          var t = l.localStorage,
                              e = Ri();
                          if (t) return t.setItem(e, "1"), t.removeItem(e), !ei() || !!l.indexedDB;
                      } catch (t) {
                  ...
                  function Ei() {
                      return (Ai() || "chrome-extension:" === ki() || hi()) && !pi() && Ti() && !fi();
                  }
                  function Ai() {
                  ...
                  function Ci(t) {
                      return "Safari" != gi((t = t || wi())) && !t.toLowerCase().match(/iphone|ipad|ipod/);
                  }
                  function Di() {
                      var t = l.___jsl;
                  ...
                  function Pi(t, e) {
                      ...
                      (this.a = t), (this.c = e), (t = wi()), (e = di()), (this.b = ri(t) || "ReactNative" === e);
                  }
                  function Li() {
                      var t = l.document;
                  ...
                  Pi.prototype.get = function () {
                      var t = l.navigator;
                      return !t || "boolean" != typeof t.onLine || (!Ai() && "chrome-extension:" !== ki() && void 0 === t.connection) || t.onLine ? (this.b ? this.c : this.a) : Math.min(5e3, this.a);
                  };
                  var ji,
                      Ui = {};
                  function Vi(t) {
                      Ui[t] || ((Ui[t] = !0), "undefined" != typeof console && "function" == typeof console.warn && console.warn(t));
                  }
                  try {
                      var Fi = {};
                      Object.defineProperty(Fi, "abcd", { configurable: !0, enumerable: !0, value: 1 }), Object.defineProperty(Fi, "abcd", { configurable: !0, enumerable: !0, value: 2 }), (ji = 2 == Fi.abcd);
                  } catch (t) {
                      ji = !1;
                  }
                  function qi(t, e, n) {
                      ji ? Object.defineProperty(t, e, { configurable: !0, enumerable: !0, value: n }) : (t[e] = n);
                  }
                  function Hi(t, e) {
                  ...
                  function Gi(t) {
                      var e = t;
                      if ("object" == typeof t && null != t) for (var n in ((e = "length" in t ? [] : {}), t)) qi(e, n, Gi(t[n]));
                      return e;
                  }
                  function Bi(t) {
                      var e = t && (t[zi] ? "phone" : null);
                      if (!(e && t && t[Yi])) throw new I("internal-error", "Internal assert: invalid MultiFactorInfo object");
                      qi(this, "uid", t[Yi]), qi(this, "displayName", t[Xi] || null);
                      var n = null;
                      t[Ji] && (n = new Date(t[Ji]).toUTCString()), qi(this, "enrollmentTime", n), qi(this, "factorId", e);
                  }
                  function Wi(t) {
                      try {
                          var e = new $i(t);
                  ...
                  function Zi(t) {
                      var e = {},
                          ...
                          i = t[rr],
                          r = t[or];
                      if (((t = Wi(t[ir])), !r || (r != tr && r != er && !n) || (r == er && !i) || (r == Qi && !t))) throw Error("Invalid checkActionCode response!");
                      r == er ? ((e[sr] = n || null), (e[cr] = n || null), (e[ar] = i)) : ((e[sr] = i || null), (e[cr] = i || null), (e[ar] = n || null)), (e[ur] = t || null), qi(this, lr, r), qi(this, hr, Gi(e));
                  }
                  e($i, Bi),
                      ($i.prototype.v = function () {
                  ...
                  function fr(t) {
                      var e = Cn((t = Dn(t)), dr) || null,
                          n = Cn(t, pr) || null,
                          i = Cn(t, gr) || null;
                      if (((i = (i && yr[i]) || null), !e || !n || !i)) throw new I("argument-error", dr + ", " + pr + "and " + gr + " are required in a valid action code URL.");
                      Hi(this, { apiKey: e, operation: i, code: n, continueUrl: Cn(t, vr) || null, languageCode: Cn(t, mr) || null, tenantId: Cn(t, br) || null });
                  }
                  var dr = "apiKey",
                      pr = "oobCode",
                      vr = "continueUrl",
                      ...
                      gr = "mode",
                      br = "tenantId",
                      yr = { recoverEmail: "RECOVER_EMAIL", resetPassword: "PASSWORD_RESET", revertSecondFactorAddition: Qi, signIn: tr, verifyAndChangeEmail: er, verifyEmail: "VERIFY_EMAIL" };
                  function wr(t) {
                      try {
                          return new fr(t);
                      } catch (t) {
                  ...
                  function Ir(t) {
                      ...
                      if (n && "object" == typeof n) {
                          ...
                          if (((n = n[_r]), "string" == typeof e && e.length)) {
                              if (((this.a = e), void 0 !== i && "boolean" != typeof i)) throw new I("argument-error", Nr + " property must be a boolean when specified.");
                              if (((this.g = !!i), void 0 !== n && ("string" != typeof n || ("string" == typeof n && !n.length)))) throw new I("argument-error", _r + " property must be a non empty string when specified.");
                              this.b = n || null;
                          } else {
                              if (void 0 !== e) throw new I("argument-error", Or + " property must be a non empty string when specified.");
                              if (void 0 !== i || void 0 !== n) throw new I("missing-android-pkg-name");
                          }
                      } else if (void 0 !== n) throw new I("argument-error", Tr + " property must be a non null object when specified.");
                      if (((this.f = null), (e = t[kr]) && "object" == typeof e)) {
                          if ("string" == typeof (e = e[Rr]) && e.length) this.f = e;
                          else if (void 0 !== e) throw new I("argument-error", Rr + " property must be a non empty string when specified.");
                      } else if (void 0 !== e) throw new I("argument-error", kr + " property must be a non null object when specified.");
                      if (void 0 !== (e = t[Ar]) && "boolean" != typeof e) throw new I("argument-error", Ar + " property must be a boolean when specified.");
                      if (((this.c = !!e), void 0 !== (t = t[Er]) && ("string" != typeof t || ("string" == typeof t && !t.length)))) throw new I("argument-error", Er + " property must be a non empty string when specified.");
                      this.i = t || null;
                  }
                  var Tr = "android",
                  ...
                  var jr = "oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version".split(" "),
                      Ur = ["client_id", "response_type", "scope", "redirect_uri", "state"],
                      Vr = {
                          kd: { Ha: "locale", ta: 700, sa: 600, ea: "facebook.com", Va: Ur },
                  ...
                  function qr(t) {
                      var e = {};
                      (e["facebook.com"] = Wr), (e["google.com"] = Jr), (e["github.com"] = Xr), (e["twitter.com"] = Yr);
                      var n = t && t[Kr];
                      try {
                  ...
                  function Br(t) {
                      Gr.call(this, t), qi(this, "profile", Gi((t = Oi(t.rawUserInfo || "{}")) || {}));
                  }
                  function Wr(t) {
                      if ((Br.call(this, t), "facebook.com" != this.providerId)) throw Error("Invalid provider ID!");
                  }
                  function Xr(t) {
                      if ((Br.call(this, t), "github.com" != this.providerId)) throw Error("Invalid provider ID!");
                      qi(this, "username", (this.profile && this.profile.login) || null);
                  }
                  function Jr(t) {
                      if ((Br.call(this, t), "google.com" != this.providerId)) throw Error("Invalid provider ID!");
                  }
                  function Yr(t) {
                      if ((Br.call(this, t), "twitter.com" != this.providerId)) throw Error("Invalid provider ID!");
                  ...
                  function zr(t) {
                      var e = Dn(t),
                          n = Cn(e, "link"),
                          i = Cn(Dn(n), "link");
                      return (e = Cn(e, "deep_link_id")), Cn(Dn(e), "link") || e || i || n || t;
                  }
                  function $r(t, e) {
                      ...
                      (this.a = t || null), (this.b = e || null), (this.type = this.a ? Zr : Qr);
                  }
                  ...
                  function no(t, e) {
                      ...
                      (this.a = e), qi(this, "providerId", t), qi(this, "signInMethod", t);
                  }
                  function io(t) {
                  ...
                  function oo(t, e, n) {
                      if (((this.a = null), e.idToken || e.accessToken))
                          e.idToken && qi(this, "idToken", e.idToken), e.accessToken && qi(this, "accessToken", e.accessToken), e.nonce && !e.pendingToken && qi(this, "nonce", e.nonce), e.pendingToken && (this.a = e.pendingToken);
                      else {
                          if (!e.oauthToken || !e.oauthTokenSecret) throw new I("internal-error", "failed to construct a credential");
                          qi(this, "accessToken", e.oauthToken), qi(this, "secret", e.oauthTokenSecret);
                      }
                  ...
                  function ao(t) {
                      ...
                      return (
                          ...
                          (e = { postBody: Gn(e).toString(), requestUri: "http://localhost" }),
                  ...
                  function uo(t, e) {
                      (this.Oc = e || []), Hi(this, { providerId: t, isOAuthProvider: !0 }), (this.Fb = {}), (this.lb = (Fr(t) || {}).Ha || null), (this.kb = null);
                  }
                  function co(t) {
                  ...
                  function fo(t) {
                      ...
                      var e = t;
                      return v(t) && (e = t.accessToken), new lo().credential({ accessToken: e });
                  }
                  function po() {
                  ...
                  function vo(t) {
                      if (!t) throw new I("argument-error", "credential failed: expected 1 argument (the OAuth access token).");
                      var e = t;
                      return v(t) && (e = t.accessToken), new po().credential({ accessToken: e });
                  }
                  function mo() {
                  ...
                  function go(t, e) {
                      var n = t;
                      return v(t) && ((n = t.idToken), (e = t.accessToken)), new mo().credential({ idToken: n, accessToken: e });
                  }
                  function bo() {
                  ...
                  function yo(t, e) {
                      var n = t;
                      if ((v(n) || (n = { oauthToken: t, oauthTokenSecret: e }), !n.oauthToken || !n.oauthTokenSecret)) throw new I("argument-error", "credential failed: expected 2 arguments (the OAuth access token and secret).");
                      return new oo("twitter.com", n, "twitter.com");
                  }
                  function wo(t, e, n) {
                      (this.a = t), (this.f = e), qi(this, "providerId", "password"), qi(this, "signInMethod", n === To.EMAIL_LINK_SIGN_IN_METHOD ? To.EMAIL_LINK_SIGN_IN_METHOD : To.EMAIL_PASSWORD_SIGN_IN_METHOD);
                  }
                  function Io(t) {
                      return t && t.email && t.password ? new wo(t.email, t.password, t.signInMethod) : null;
                  }
                  function To() {
                      Hi(this, { providerId: "password", isOAuthProvider: !1 });
                  }
                  function Eo(t, e) {
                      if (!(e = Ao(e))) throw new I("argument-error", "Invalid email link!");
                  ...
                  function ko(t) {
                      ...
                      (this.a = t), qi(this, "providerId", "phone"), (this.ea = "phone"), qi(this, "signInMethod", "phone");
                  }
                  function So(e) {
                      if (e && "phone" === e.providerId && ((e.verificationId && e.verificationCode) || (e.temporaryProof && e.phoneNumber))) {
                          var n = {};
                          return (
                              U(["verificationId", "verificationCode", "temporaryProof", "phoneNumber"], function (t) {
                                  e[t] && (n[t] = e[t]);
                              }),
                              new ko(n)
                          );
                  ...
                  function No(t) {
                      return t.a.Ja && t.a.da ? { temporaryProof: t.a.Ja, phoneNumber: t.a.da } : { sessionInfo: t.a.bb, code: t.a.ab };
                  }
                  function _o(t) {
                      try {
                          this.a = t || Xl.auth();
                              ...
                              default:
                                  return n || i || o || a
                                      ? a
                                          ? 0 == e.indexOf("saml.")
                                              ? new no(e, a)
                                              : new oo(e, { pendingToken: a, idToken: t.oauthIdToken, accessToken: t.oauthAccessToken }, e)
                                          : new ho(e).credential({ idToken: o, accessToken: n, rawNonce: r })
                                      : null;
                          }
                      } catch (t) {
                          return null;
                  ...
                  function Po(t) {
                      return (t = t || {}).type ? new Do(t.type, t.eventId, t.urlResponse, t.sessionId, t.error && T(t.error), t.postBody, t.tenantId) : null;
                  }
                  function Lo() {
                      (this.b = null), (this.a = []);
                  }
                  ($r.prototype.Fa = function () {
                      ...
                      ($r.prototype.v = function () {
                          return this.type == Zr ? { multiFactorSession: { idToken: this.a } } : { multiFactorSession: { pendingCredential: this.b } };
                      }),
                      ...
                      (ho.prototype.credential = function (t, e) {
                          var n;
                          if (!(n = v(t) ? { idToken: t.idToken || null, accessToken: t.accessToken || null, nonce: t.rawNonce || null } : { idToken: t || null, accessToken: e || null }).idToken && !n.accessToken)
                              throw new I("argument-error", "credential failed: must provide the ID token and/or the access token.");
                      ...
                      (wo.prototype.ia = function (t) {
                          return this.signInMethod == To.EMAIL_LINK_SIGN_IN_METHOD ? Xs(t, ws, { email: this.a, oobCode: this.f }) : Xs(t, Hs, { email: this.a, password: this.f });
                      }),
                      (wo.prototype.b = function (t, e) {
                          return this.signInMethod == To.EMAIL_LINK_SIGN_IN_METHOD ? Xs(t, Is, { idToken: e, email: this.a, oobCode: this.f }) : Xs(t, Ls, { idToken: e, email: this.a, password: this.f });
                      }),
                      ...
                      (_o.prototype.cb = function (r, n) {
                          ...
                          return Te(n.verify()).then(function (i) {
                              ...
                              switch (n.type) {
                                  case "recaptcha":
                                      ...
                                      return (t && t.type == Zr
                                          ? t.Fa().then(function (t) {
                                                return Xs(o, xs, { idToken: t, phoneEnrollmentInfo: { phoneNumber: e, recaptchaToken: i } }).then(function (t) {
                                          ...
                                          ? t.Fa().then(function (t) {
                                                return (
                                                    (e = o),
                                                    (n = { mfaPendingCredential: t, mfaEnrollmentId: (r.multiFactorHint && r.multiFactorHint.uid) || r.multiFactorUid, phoneSignInInfo: { recaptchaToken: i } }),
                                  ...
                                  default:
                                      throw new I("argument-error", 'Only firebase.auth.ApplicationVerifiers with type="recaptcha" are currently supported.');
                              }
                          });
                      }),
                  ...
                  function jo(t) {
                      ...
                      (t = i.b),
                          "chrome-extension" == (i = i.f)
                              ...
                              : "http" == i || "https" == i
                              ? (n = xt("This domain (%s) is not authorized to run this operation. Add it to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.", t))
                              : (e = "operation-not-supported-in-this-environment"),
                          I.call(this, e, n);
                  }
                  function Uo(t, e, n) {
                      I.call(this, t, n), (t = e || {}).Gb && qi(this, "email", t.Gb), t.da && qi(this, "phoneNumber", t.da), t.credential && qi(this, "credential", t.credential), t.Wb && qi(this, "tenantId", t.Wb);
                  }
                  function Vo(t) {
                      if (t.code) {
                          var e = t.code || "";
                  ...
                  Jo.prototype.log = function (t, e, n) {
                      if (
                          ...
                          for (p(e) && (e = e()), t = new Xo(t, String(e), this.f), n && (t.a = n), n = this; n; ) n = n.a;
                  };
                  var ta,
                      ea = {},
                      na = null;
                  function ia(t) {
                      var e;
                      if ((na || ((na = new Jo("")), ((ea[""] = na).c = Zo)), !(e = ea[t]))) {
                          e = new Jo(t);
                          var n = t.lastIndexOf("."),
                              i = t.substr(n + 1);
                          (n = ia(t.substr(0, n))).b || (n.b = {}), ((n.b[i] = e).a = n), (ea[t] = e);
                      }
                      return e;
                  }
                  function ra(t, e) {
                  ...
                  function ca(t, e) {
                      e && t.f && ((t.status = t.f.status), (t.statusText = t.f.statusText)), (t.readyState = 4), (t.f = null), (t.c = null), (t.l = null), ha(t);
                  }
                  function ha(t) {
                  ...
                  ((t = aa.prototype).open = function (t, e) {
                      if (this.readyState != sa) throw (this.abort(), Error("Error reopening a connection"));
                      ...
                      (t.abort = function () {
                          (this.response = this.responseText = ""),
                              ...
                              1 <= this.readyState && this.a && 4 != this.readyState && ((this.a = !1), ca(this, !1)),
                              (this.readyState = sa);
                      }),
                      (t.sc = function (t) {
                          this.a &&
                              ((this.f = t),
                              this.b || ((this.b = t.headers), (this.readyState = 2), ha(this)),
                              this.a &&
                                  ((this.readyState = 3),
                                  ha(this),
                                  this.a &&
                                      ("arraybuffer" === this.responseType
                                          ...
                                          ? ((this.response = this.responseText = ""), (this.c = t.body.getReader()), (this.l = new TextDecoder()), ua(this))
                                          : t.text().then(this.rc.bind(this), this.Sa.bind(this)))));
                      }),
                      (t.nc = function (t) {
                          if (this.a) {
                              var e = this.l.decode(t.value ? t.value : new Uint8Array(0), { stream: !t.done });
                              e && (this.response = this.responseText += e), t.done ? ca(this, !0) : ha(this), 3 == this.readyState && ua(this);
                          }
                      }),
                      (t.rc = function (t) {
                      ...
                      (t.Sa = function (t) {
                          var e = this.h;
                          e && e.log($o, "Failed to fetch url " + this.g, t instanceof Error ? t : Error(t)), this.a && ca(this, !0);
                      }),
                      (t.setRequestHeader = function (t, e) {
                          this.i.append(t, e);
                      }),
                      (t.getResponseHeader = function (t) {
                          return this.b ? this.b.get(t.toLowerCase()) || "" : ((t = this.h) && t.log($o, "Attempting to get response header but no headers have been received for url: " + this.g, void 0), "");
                      }),
                      (t.getAllResponseHeaders = function () {
                          if (!this.b) {
                              var t = this.h;
                              return t && t.log($o, "Attempting to get all response headers but no headers have been received for url: " + this.g, void 0), "";
                          }
                          t = [];
                  ...
                  function va(e, t, n, i, r) {
                      ...
                      (n = n ? n.toUpperCase() : "GET"), (e.l = t), (e.h = ""), (e.P = n), (e.N = !1), (e.c = !0), (e.a = e.D ? e.D.a() : Mo.a()), (e.B = e.D ? qo(e.D) : qo(Mo)), (e.a.onreadystatechange = b(e.Sb, e));
                      try {
                          ra(e.b, Aa(e, "Opening Xhr")), (e.O = !0), e.a.open(n, String(t), !0), (e.O = !1);
                      } catch (t) {
                          return ra(e.b, Aa(e, "Error opening Xhr: " + t.message)), void ga(e, t);
                      }
                      t = i || "";
                      var o,
                          a = new Tn(e.headers);
                      r &&
                          (function (t, e) {
                              ...
                              else for (var n = In(t), i = wn(t), r = i.length, o = 0; o < r; o++) e.call(void 0, i[o], n && n[o], t);
                          })(r, function (t, e) {
                              a.set(e, t);
                          }),
                          (r = (function (t) {
                              t: {
                                  for (var e = ma, n = t.length, i = "string" == typeof t ? t.split("") : t, r = 0; r < n; r++)
                          ...
                          !H(pa, n) || r || i || a.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"),
                          a.forEach(function (t, e) {
                              this.a.setRequestHeader(e, t);
                          }, e),
                          e.m && (e.a.responseType = e.m),
                          "withCredentials" in e.a && e.a.withCredentials !== e.R && (e.a.withCredentials = e.R);
                      try {
                          Ia(e),
                              0 < e.g &&
                                  ((e.w = ((o = e.a), Ht && Qt(9) && "number" == typeof o.timeout && void 0 !== o.ontimeout)),
                                  ra(e.b, Aa(e, "Will abort after " + e.g + "ms if incomplete, xhr2 " + e.w)),
                                  e.w ? ((e.a.timeout = e.g), (e.a.ontimeout = b(e.Ka, e))) : (e.s = bn(e.Ka, e.g, e))),
                  ...
                  function ga(t, e) {
                      (t.c = !1), t.a && ((t.f = !0), t.a.abort(), (t.f = !1)), (t.h = e), ba(t), wa(t);
                  }
                  function ba(t) {
                  ...
                  function ya(e) {
                      if (e.c && void 0 !== u)
                          if (e.B[1] && 4 == Ta(e) && 2 == Ea(e)) ra(e.b, Aa(e, "Local request error detected and ignored"));
                  ...
                  function wa(e, t) {
                      if (e.a) {
                          ...
                          try {
                              ...
                              (e = e.b) && e.log(zo, "Problem encountered resetting onreadystatechange: " + t.message, void 0);
                          }
                      }
                  }
                  function Ia(t) {
                  ...
                  function Ra(e) {
                      ...
                      (e.c = n), t && ((s = b(e.m, e, !0)), (t = b(e.m, e, !1)), n instanceof ka ? (_a(n, s, t), (n.B = !0)) : n.then(s, t)), i && ((n = new Pa(n)), (La[n.a] = n), (e.h = n.a));
                  }
                  function Ca() {
                      O.call(this);
                  }
                  ...
                  ((t = la.prototype).Ka = function () {
                      void 0 !== u && this.a && ((this.h = "Timed out after " + this.g + "ms, aborting"), ra(this.b, Aa(this, this.h)), this.dispatchEvent("timeout"), this.abort(8));
                  }),
                      (t.abort = function () {
                          this.a && this.c && (ra(this.b, Aa(this, "Aborting")), (this.c = !1), (this.f = !0), this.a.abort(), (this.f = !1), this.dispatchEvent("complete"), this.dispatchEvent("abort"), wa(this));
                      }),
                      (t.Ba = function () {
                          this.a && (this.c && ((this.c = !1), (this.f = !0), this.a.abort(), (this.f = !1)), wa(this, !0)), la.Za.Ba.call(this);
                      }),
                      (t.Sb = function () {
                      ...
                      (ka.prototype.cancel = function (t) {
                          if (this.a) this.c instanceof ka && this.c.cancel();
                              ...
                              this.w ? this.w.call(this.s, this) : (this.u = !0), this.a || ((t = new Da()), Na(this), Sa(this, !1, t));
                          }
                      }),
                  ...
                  function Ma(t) {
                      ...
                      return (
                          ...
                          (u.onload = u.onreadystatechange = function () {
                              (u.readyState && "loaded" != u.readyState && "complete" != u.readyState) || (ja(u, !1, e), Na(h), Sa(h, !0, null));
                          }),
                          (u.onerror = function () {
                              ja(u, !0, e);
                          ...
                          (n.src = yt(i)),
                          null === d && (d = (i = (i = l.document).querySelector && i.querySelector("script[nonce]")) && (i = i.nonce || i.getAttribute("nonce")) && f.test(i) ? i : ""),
                          (i = d) && n.setAttribute("nonce", i),
                          ((o = ((r = a) || document).getElementsByTagName("HEAD")) && 0 != o.length ? o[0] : r.documentElement).appendChild(u),
                          h
                      );
                  }
                  function xa() {
                  ...
                  function Ha(t, e, n) {
                      if (
                          ((this.c = t),
                          (t = e || {}),
                          (this.u = t.secureTokenEndpoint || "https://securetoken.googleapis.com/v1/token"),
                          ...
                          (n = "Node" == di()),
                          !(n = l.XMLHttpRequest || (n && Xl.INTERNAL.node && Xl.INTERNAL.node.XMLHttpRequest)) && !fi())
                      )
                          throw new I("internal-error", "The XMLHttpRequest compatibility library was not found.");
                      (this.f = void 0), fi() ? (this.f = new oa(self)) : pi() ? (this.f = new qa(n)) : (this.f = new Go()), (this.b = null);
                  }
                  e(Fa, O),
                      e(qa, Fo),
                  ...
                  function $a(t, e, n, i, r, o, a) {
                      var s;
                      (t =
                          !(((s = gi((s = wi())) == mi && (s = s.match(/\sChrome\/(\d+)/i)) && 2 == s.length ? parseInt(s[1], 10) : null) && s < 30) || (Ht && $t && !(9 < $t))) || fi()
                              ? b(t.w, t)
                              : ((Ka =
                                    Ka ||
                                    new ve(function (t, e) {
                  ...
                  (Ha.prototype.S = function () {
                      ...
                      (Ha.prototype.w = function (t, n, e, i, r, o) {
                          if (fi() && (void 0 === l.fetch || void 0 === l.Headers || void 0 === l.Request))
                              throw new I("operation-not-supported-in-this-environment", "fetch, Headers and Request native APIs or equivalent Polyfills must be available to support HTTP requests from a Worker environment.");
                          var a = new la(this.f);
                          if (o) {
                              a.g = Math.max(0, o);
                                      ...
                                      JSON.parse(
                                          (function (e) {
                                              try {
                                                  ...
                                                  return ra(e.b, "Can not get responseText: " + t.message), "";
                                              }
                                          })(this)
                                      ) || null;
                              } catch (t) {
                  ...
                  var Za = new dt(mt, "https://apis.google.com/js/client.js?onload=%{onload}"),
                  ...
                  function ts(t, e, n, i, r, o, a) {
                      ...
                      return new ve(function (e, n) {
                          $a(
                              ...
                              s.toString(),
                              function (t) {
                                  t ? (t.error ? n(Ys(t, o || {})) : e(t)) : n(new I("network-request-failed"));
                              },
                              i,
                              u ? void 0 : zn(_i(r)),
                              t.a,
                  ...
                  function es(t) {
                      if ("string" != typeof (t = t.email) || !ui.test(t)) throw new I("invalid-email");
                  }
                  function ns(t) {
                      "email" in t && es(t);
                  }
                  ...
                  function us(t, e) {
                      return (
                          e.oauthIdToken &&
                              ...
                              !e.pendingToken &&
                              (t.sessionId ? (e.nonce = t.sessionId) : t.postBody && Wn((t = new Hn(t.postBody)), "nonce") && (e.nonce = t.get("nonce"))),
                          e
                      );
                  }
                  function cs(t) {
                      ...
                      if (
                          (t.needConfirmation
                              ? ((t.code = "account-exists-with-different-credential"), (e = Vo(t)))
                  ...
                  ((t = Ha.prototype).zb = function (t, i) {
                      ...
                      (t.rb = function (t, e) {
                          return lt((t = { requestType: "PASSWORD_RESET", email: t }), e), Xs(this, _s, t);
                      }),
                      (t.sb = function (t, e) {
                          return lt((t = { requestType: "EMAIL_SIGNIN", email: t }), e), Xs(this, ks, t);
                      }),
                      (t.qb = function (t, e) {
                          return lt((t = { requestType: "VERIFY_EMAIL", idToken: t }), e), Xs(this, Ss, t);
                      }),
                      (t.Ab = function (t, e, n) {
                          return lt((t = { requestType: "VERIFY_AND_CHANGE_EMAIL", idToken: t, newEmail: e }), n), Xs(this, Ns, t);
                      }),
                      (t.cb = function (t) {
                          return Xs(this, Ks, t);
                      }),
                  ...
                  var ps = { endpoint: "setAccountInfo", A: ds, Y: "email", C: !0 },
                      ...
                      ws = { endpoint: "emailLinkSignin", M: ["email", "oobCode"], A: es, G: is, U: !0, C: !0 },
                      Is = { endpoint: "emailLinkSignin", M: ["idToken", "email", "oobCode"], A: es, G: is, U: !0 },
                      Ts = { endpoint: "accounts/mfaEnrollment:finalize", M: ["idToken", "phoneVerificationInfo"], A: as, G: is, C: !0, La: !0 },
                      Es = { endpoint: "accounts/mfaSignIn:finalize", M: ["mfaPendingCredential", "phoneVerificationInfo"], A: as, G: is, C: !0, La: !0 },
                      ...
                      Ds = { endpoint: "sendVerificationCode", M: ["phoneNumber", "recaptchaToken"], Y: "sessionInfo", C: !0 },
                      ...
                      Us = { endpoint: "verifyAssertion", A: ss, Wa: us, G: cs, U: !0, C: !0 },
                      Vs = {
                      ...
                      Gs = {
                          ...
                          G: function (t) {
                              if (t.temporaryProof) throw ((t.code = "credential-already-in-use"), Vo(t));
                              is(t);
                          },
                      },
                      Bs = { Eb: { USER_NOT_FOUND: "user-not-found" }, endpoint: "verifyPhoneNumber", A: rs, G: is, C: !0 },
                      Ws = {
                  ...
                  function Xs(t, e, n) {
                      ...
                      return Te(n)
                          .then(e.A)
                          .then(function () {
                              return e.U && (n.returnSecureToken = !0), e.C && t.b && void 0 === n.tenantId && (n.tenantId = t.b), ts(t, r ? t.l : t.h, e.endpoint, o, n, e.Eb, e.hb || !1);
                          })
                          .then(function (t) {
                  ...
                  function Js(t) {
                      return Ys({ error: { errors: [{ message: t }], code: 400, message: t } });
                  }
                  function Ys(t, e) {
                                      ...
                                      Ii("gapi.iframes.getContext")().open(
                                          {
                                              where: document.body,
                                              url: o.b,
                                              messageHandlersFilter: Ii("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"),
                  ...
                  var $s = new dt(mt, "https://apis.google.com/js/api.js?onload=%{onload}"),
                      Zs = new Pi(3e4, 6e4),
                      Qs = new Pi(5e3, 15e3),
                      tu = null;
                  function eu(t, e, n) {
                      (this.i = t), (this.g = e), (this.h = n), (this.f = null), (this.a = Pn(this.i, "/__/auth/iframe")), Rn(this.a, "apiKey", this.g), Rn(this.a, "appName", this.h), (this.b = null), (this.c = []);
                  }
                                      ...
                                      if (
                                          (o =
                                              0 == r.indexOf("chrome-extension://")
                                                  ...
                                                  : ("http" == a || "https" == a) && (si.test(r) ? o == r : ((r = r.split(".").join("\\.")), new RegExp("^(.+\\." + r + "|" + r + ")$", "i").test(o))))
                                      ) {
                                          t = !0;
                                          break t;
                                      }
                          ...
                          r.l ||
                              (r.l = ci().then(function () {
                                  if (!r.s) {
                                      ...
                                      (i.f = t), (i.b = e), (i.c = W(n || [])), (r.s = i.toString());
                                  }
                                  (r.i = new zs(r.s)),
                                      (function (i) {
                                          ...
                                          !(function (t, e) {
                                              t.nb.then(function () {
                                                  t.a.register("authEvent", e, Ii("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"));
                                              });
                                          })(i.i, function (t) {
                                              var e = {};
                                              if (t && t.authEvent) {
                                                  var n = !1;
                                                  for (t = Po(t.authEvent), e = 0; e < i.g.length; e++) n = i.g[e](t) || n;
                  ...
                  function su(t) {
                      return t.m || ((t.w = t.c ? yi(t.c, iu(t.b)) : null), (t.m = new Ha(t.f, N(t.h), t.w))), t.m;
                  }
                  function uu(t, e, n, i, r, o, a, s, u, c, h) {
                      return ((t = new nu(t, e, n, i, r)).l = o), (t.g = a), (t.i = s), (t.b = ct(u || null)), (t.f = c), t.ub(h).toString();
                  }
                  function cu(t) {
                      if (((this.a = t || (Xl.INTERNAL.reactNative && Xl.INTERNAL.reactNative.AsyncStorage)), !this.a)) throw new I("internal-error", "The React Native compatibility library was not found.");
                  ...
                  (eu.prototype.toString = function () {
                      return this.f ? Rn(this.a, "v", this.f) : Bn(this.a.a, "v"), this.b ? Rn(this.a, "eid", this.b) : Bn(this.a.a, "eid"), this.c.length ? Rn(this.a, "fw", this.c.join(",")) : Bn(this.a.a, "fw"), this.a.toString();
                  }),
                      ...
                      (nu.prototype.toString = function () {
                          ...
                          if ((Rn(t, "apiKey", this.m), Rn(t, "appName", this.c), Rn(t, "authType", this.u), this.a.isOAuthProvider)) {
                              var e = this.a;
                              try {
                              ...
                              for (var i in ((e.kb = n), Rn(t, "providerId", this.a.providerId), (n = _i((e = this.a).Fb)))) n[i] = n[i].toString();
                              (i = e.Oc), (n = ct(n));
                              for (var r = 0; r < i.length; r++) {
                                  var o = i[r];
                                  o in n && delete n[o];
                              }
                              e.lb && e.kb && !n[e.lb] && (n[e.lb] = e.kb), ut(n) || Rn(t, "customParameters", Ni(n));
                          }
                          if (
                              ("function" == typeof this.a.Nb && (e = this.a.Nb()).length && Rn(t, "scopes", e.join(",")),
                              this.l ? Rn(t, "redirectUrl", this.l) : Bn(t.a, "redirectUrl"),
                              this.g ? Rn(t, "eventId", this.g) : Bn(t.a, "eventId"),
                              this.i ? Rn(t, "v", this.i) : Bn(t.a, "v"),
                              this.b)
                          )
                              for (var a in this.b) this.b.hasOwnProperty(a) && !Cn(t, a) && Rn(t, a, this.b[a]);
                          return this.h ? Rn(t, "tid", this.h) : Bn(t.a, "tid"), this.f ? Rn(t, "eid", this.f) : Bn(t.a, "eid"), (a = iu(this.c)).length && Rn(t, "fw", a.join(",")), t.toString();
                      }),
                                      ...
                                      au((t = o))
                                          .then(function () {
                                              return (
                                                  ...
                                                  e.nb.then(function () {
                                                      return new ve(function (t) {
                                                          e.a.send(n.type, n, t, Ii("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"));
                                                      });
                                                  })
                                              );
                                              var e, n;
                      ...
                      (t.Jb = function (e, t, n, i, r, o, a, s) {
                          ...
                          return this.a
                              ...
                              .then(function () {
                                  Co(n), a || ii(uu(u.u, u.f, u.b, t, n, null, o, u.c, void 0, u.h, s), e);
                              })
                              .o(function (t) {
                      ...
                      (t.Kb = function (t, e, n, i) {
                          ...
                          return this.a
                              .then(function () {
                                  Co(e), ii(uu(r.u, r.f, r.b, t, e, ni(), n, r.c, void 0, r.h, i));
                              })
                              .o(function (t) {
                                    ...
                                    onMessage: (o = function (t) {
                                        t.data.eventId === r &&
                                            ("ack" === t.data.status
                                                ...
                                                : "done" === t.data.status
                                                ? (clearTimeout(s), void 0 !== t.data.response ? e(t.data.response) : n(Error("unknown_error")))
                                                : (clearTimeout(a), clearTimeout(s), n(Error("invalid_response"))));
                                    }),
                                }),
                                i.a.push(c),
                                l.port1.addEventListener("message", o),
                                i.c.postMessage({ eventType: t, eventId: r, data: u }, [l.port2]))
                      ...
                      return new ve(function (e, n) {
                          ...
                          (t.onerror = function (t) {
                              ...
                              (t.onsuccess = function (t) {
                                  var i;
                                  (t = t.target.result).objectStoreNames.contains("firebaseLocalStorage")
                                      ? e(t)
                                      : ((i = r),
                                        new ve(function (t, e) {
                  ...
                  function ku(t, e) {
                      return t.g && t.h && (((n = l.navigator) && n.serviceWorker && n.serviceWorker.controller) || null) === t.h
                  ...
                  function Ru() {
                      if (
                          !(function () {
                              var t = "Node" == di();
                              if (!(t = Cu() || (t && Xl.INTERNAL.node && Xl.INTERNAL.node.localStorage))) return;
                              try {
                          ...
                          if ("Node" == di()) throw new I("internal-error", "The LocalStorage compatibility library was not found.");
                          throw new I("web-storage-unsupported");
                      }
                      (this.a = Cu() || Xl.INTERNAL.node.localStorage), (this.type = "localStorage");
                  }
                  function Cu() {
                      try {
                          var t = l.localStorage,
                  ...
                  function Pu() {
                      if (
                          !(function () {
                              var t = "Node" == di();
                              if (!(t = Lu() || (t && Xl.INTERNAL.node && Xl.INTERNAL.node.sessionStorage))) return;
                              try {
                                  return t.setItem("__sak", "1"), t.removeItem("__sak"), 1;
                              } catch (t) {
                                  return;
                          ...
                          if ("Node" == di()) throw new I("internal-error", "The SessionStorage compatibility library was not found.");
                          throw new I("web-storage-unsupported");
                      }
                      (this.a = Lu() || Xl.INTERNAL.node.sessionStorage), (this.type = "sessionStorage");
                  }
                  function Lu() {
                      try {
                  ...
                  function Mu() {
                      var t = {};
                      (t.Browser = Uu), (t.Node = Vu), (t.ReactNative = Fu), (t.Worker = qu), (this.a = t[di()]);
                  }
                  (hu.prototype.c = function (n) {
                      ...
                      if (t && 0 < t.length) {
                          ...
                          U(t, function (t) {
                              ...
                              ke(e).then(function (t) {
                                  var e = [];
                                  U(t, function (t) {
                                      e.push({ fulfilled: t.Mb, value: t.value, reason: t.reason ? t.reason.message : void 0 });
                                  }),
                                      U(e, function (t) {
                      ...
                      ((t = bu.prototype).set = function (n, i) {
                          ...
                          return wu(this)
                              ...
                              .then(function (t) {
                                  var e = Tu(Eu(r, !0));
                                  return t ? ((t.value = i), Au(e.put(t))) : (a.b++, (o = !0), ((t = {}).fbase_key = n), (t.value = i), Au(e.add(t)));
                              })
                              .then(function () {
                  ...
                  function Ku() {
                      var t = !(Ci(wi()) || !li()),
                          e = Si(),
                          n = Ti();
                      (this.m = t), (this.h = e), (this.l = n), (this.a = {}), (t = xu = xu || new Mu());
                      try {
                          this.g = (!ei() && xi()) || !l.indexedDB ? new t.a.F() : new _u(fi() ? new Ou() : new t.a.F());
                      } catch (t) {
                  ...
                  function Xu(t, e, n) {
                      return (n = Wu(e, n)), "local" == e.F && (t.b[n] = null), Bu(t, e.F).T(n);
                  }
                  function Ju(t) {
                                      ...
                                      (i.c = setInterval(function () {
                                          for (var t in i.a) {
                                              var e = l.localStorage.getItem(t),
                                                  n = i.b[t];
                                              e != n && ((i.b[t] = e), (e = new Ge({ type: "storage", key: t, target: window, oldValue: n, newValue: e, a: !0 })), i.Vb(e));
                                          }
                                      }, 1e3)))),
                              this.a[t] || (this.a[t] = []),
                              this.a[t].push(n);
                      ...
                      (t.Vb = function (t) {
                          if (t && t.f) {
                              ...
                              if (null == e)
                                  ...
                                  if ((void 0 !== t.a.a ? Bu(this, "local").ha(this.f) : Ju(this), this.m))
                  ...
                  for (var tc = 64, ec = tc - 1, nc = [], ic = 0; ic < ec; ic++) nc[ic] = 0;
                  var rc = B(128, nc);
                  function oc(t) {
                      ...
                      for (o = 0 | t.a[7], e = 0; e < 64; e++) {
                          ...
                          (a = ((o = (o + (((c >>> 6) | (c << 26)) ^ ((c >>> 11) | (c << 21)) ^ ((c >>> 25) | (c << 7)))) | 0) + (((a = ((a = (c & h) ^ (~c & l)) + (0 | zu[e])) | 0) + (0 | n[e])) | 0)) | 0),
                              (o = l),
                              (l = h),
                              (h = c),
                              (c = (u + a) | 0),
                  ...
                  function ac(t, e, n) {
                      ...
                      var i = 0,
                          r = t.c;
                      if ("string" == typeof e) for (; i < n; ) (t.f[r++] = e.charCodeAt(i++)), r == t.b && (oc(t), (r = 0));
                      else {
                  ...
                  e(uc, Qu);
                  var cc = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225];
                  function hc(t, e, n, i, r) {
                      (this.u = t), (this.i = e), (this.l = n), (this.m = i || null), (this.s = r || null), (this.h = e + ":" + n), (this.w = new Zu()), (this.g = new Yu(this.h)), (this.f = null), (this.b = []), (this.a = this.c = null);
                  }
                  function lc(t) {
                  ...
                  function fc(t) {
                      ...
                      for (oc(e), i = n = 0; i < e.i; i++) for (var r = 24; 0 <= r; r -= 8) t[n++] = (e.a[i] >> r) & 255;
                              ...
                              (s.f = s.ka().then(function () {
                                  return new ve(function (n) {
                                      function e(i) {
                                          (t = !0),
                                              ...
                                              vc(r).then(function (t) {
                                                  ...
                                                  if (t && i && i.url) {
                                                      var n = null;
                                                      -1 != (e = zr(i.url)).indexOf("/__/auth/callback") &&
                                                          (n = (n = "object" == typeof (n = Oi(Cn((n = Dn(e)), "firebaseError") || null)) ? T(n) : null)
                                      ...
                                      s.Ca(function t(e) {
                                          ...
                                          (r = s),
                                          (o = new Do("unknown", null, null, null, new I("no-auth-event"))),
                                          (t = !1),
                                          ...
                                          (l.handleOpenURL = function (t) {
                                              if ((0 == t.toLowerCase().indexOf(Ii("BuildInfo.packageName", l).toLowerCase() + "://") && e({ url: t }), "function" == typeof i))
                                                  try {
                                                      i(t);
                                                  } catch (t) {
                                                      console.error(t);
                                          ...
                                          (function (t) {
                                              ...
                                              n.a.push(t),
                                                  n.b ||
                                                      ...
                                                      "function" == typeof (t = Ii("universalLinks.subscribe", l)) && t(null, n.b));
                                          })(e);
                                  });
                              })),
                          s.f
                  ...
                  ((t = hc.prototype).ka = function () {
                      return this.Ga
                          ...
                          : (this.Ga = (hi(void 0)
                                ...
                                : Ee(Error("Cordova must run in an Android or iOS file scheme."))
                            ).then(
                                function () {
                                    if ("function" != typeof Ii("universalLinks.subscribe", l)) throw lc("cordova-universal-links-plugin-fix is not installed");
                                    if (void 0 === Ii("BuildInfo.packageName", l)) throw lc("cordova-plugin-buildinfo is not installed");
                                    if ("function" != typeof Ii("cordova.plugins.browsertab.openUrl", l)) throw lc("cordova-plugin-browsertab is not installed");
                                    if ("function" != typeof Ii("cordova.InAppBrowser.open", l)) throw lc("cordova-plugin-inappbrowser is not installed");
                                },
                                function () {
                      ...
                      (t.Lb = function (t, e) {
                          return e(new I("operation-not-supported-in-this-environment")), Te();
                      }),
                      (t.Jb = function () {
                              ...
                              .then(function () {
                                  return (function (n, t, e, i, r) {
                                      var o = (function () {
                                          ...
                                          a = new Do(t, i, null, o, new I("no-auth-event"), null, r),
                                      ...
                                      return n
                                          ...
                                          .then(function () {
                                              ...
                                              t(function (t) {
                                                  if (t) {
                                                      if ("function" != typeof (e = Ii("cordova.plugins.browsertab.openUrl", l))) throw new I("invalid-cordova-configuration");
                                                      e(h);
                                                  } else {
                                                      if ("function" != typeof (e = Ii("cordova.InAppBrowser.open", l))) throw new I("invalid-cordova-configuration");
                                                      (t = wi()), (n.a = e(h, t.match(/(iPad|iPhone|iPod).*OS 7_\d/i) || t.match(/(iPad|iPhone|iPod).*OS 8_\d/i) ? "_blank" : "_system", "location=yes"));
                                                  }
                                              });
                                          });
                                  })(r, t, e, n, i);
                              ...
                              .then(function () {
                                  return new ve(function (e, t) {
                                      (s = function () {
                                          ...
                                          wi()
                                              .toLowerCase()
                                              .match(/android/) || o.addEventListener("visibilitychange", c, !1);
                                  }).o(function (t) {
                                      return vc(r).then(function () {
                                          throw t;
                                      });
                      ...
                      (t.Ca = function (e) {
                          this.b.push(e),
                              pc(this).o(function (t) {
                                  "auth/invalid-cordova-configuration" === t.code && ((t = new Do("unknown", null, null, null, new I("no-auth-event"))), e(t));
                              });
                      }),
                      (t.Qa = function (e) {
                          G(this.b, function (t) {
                  ...
                  function Tc(n) {
                      n.a.Ub() &&
                          Ic(n).o(function (t) {
                              var e = new Do("unknown", null, null, null, new I("operation-not-supported-in-this-environment"));
                              _c(t) && n.s(e);
                          }),
                          n.a.Qb() || Lc(n.b);
                  }
                  ...
                  (yc.prototype.reset = function () {
                      (this.f = !1), this.a.Qa(this.l), (this.a = wc(this.D, this.u, this.m)), (this.i = {});
                  }),
                  ...
                  function Oc(e, t, n, i, r) {
                      ...
                      return (a = e.g).b.set(gc, "pending", a.a).then(function () {
                          return e.a
                              .Kb(t, n, i, r)
                              .o(function (t) {
                                  if (_c(t)) throw new I("operation-not-supported-in-this-environment");
                                  return (
                                      (o = t),
                  ...
                  function Kc(t, e, n) {
                      ...
                      (this.a = t), (this.f = ct(e)), (this.g = n), (this.c = new $r(null, i)), (this.b = []);
                      var r = this;
                      U(e[Gc] || [], function (t) {
                          (t = Wi(t)) && r.b.push(t);
                      }),
                  ...
                  function Wc(t, e, n, i) {
                      I.call(this, "multi-factor-auth-required", i, e), (this.b = new Kc(t, e, n)), qi(this, "resolver", this.b);
                  }
                  function Xc(t, e, n) {
                  ...
                  function zc(t) {
                      if ((Yc.call(this, t), this.a.ea != _o.PROVIDER_ID)) throw new I("argument-error", "firebase.auth.PhoneMultiFactorAssertion requires a valid firebase.auth.PhoneAuthCredential");
                  }
                  function $c(t, e) {
                      for (var n in (Ke.call(this, t), e)) this[n] = e[n];
                  }
                  function Zc(t, e) {
                      (this.a = t), (this.b = []), (this.c = b(this.wc, this)), en(this.a, "userReloaded", this.c);
                      var i = [];
                      e &&
                          e.multiFactor &&
                          ...
                          U(e.multiFactor.enrolledFactors, function (t) {
                              var e = null,
                                  n = {};
                              if (t) {
                                  t.uid && (n[Yi] = t.uid), t.displayName && (n[Xi] = t.displayName), t.enrollmentTime && (n[Ji] = new Date(t.enrollmentTime).toISOString()), t.phoneNumber && (n[zi] = t.phoneNumber);
                                  try {
                                      e = new $i(n);
                                  } catch (t) {}
                                  t = e;
                  ...
                  function oh(e, t) {
                      return (
                          ...
                          (r = t),
                          new ve(function (e, n) {
                              ("refresh_token" == r.grant_type && r.refresh_token) || ("authorization_code" == r.grant_type && r.code)
                                  ? $a(
                                        i,
                                        i.u + "?key=" + encodeURIComponent(i.c),
                                        function (t) {
                                            t ? (t.error ? n(Ys(t)) : t.access_token && t.refresh_token ? e(t) : n(new I("internal-error"))) : n(new I("network-request-failed"));
                                        },
                                        "POST",
                                        Gn(r).toString(),
                                        i.g,
                              ...
                              .then(function (t) {
                                  return (e.b = Mr(t.access_token)), (e.a = t.refresh_token), { accessToken: e.b.toString(), refreshToken: e.a };
                              })
                              .o(function (t) {
                  ...
                  function ah(t, e) {
                      (this.a = t || null), (this.b = e || null), Hi(this, { lastSignInTime: Mi(e || null), creationTime: Mi(t || null) });
                  }
                  function sh(t, e, n, i, r, o) {
                      Hi(this, { uid: t, displayName: i || null, photoURL: r || null, email: n || null, phoneNumber: o || null, providerId: e });
                  }
                  function uh(t, e, n) {
                      var i;
                      (this.N = []),
                  ...
                  function ch(t, e) {
                      t.aa && on(t.aa, "languageCodeChanged", t.za), (t.aa = e) && en(e, "languageCodeChanged", t.za);
                  }
                  function hh(t, e) {
                      (t.W = e), za(t.a, Xl.SDK_VERSION ? yi(Xl.SDK_VERSION, t.W) : null);
                  }
                  function lh(t, e) {
                      t.$ && on(t.$, "frameworkChanged", t.ya), (t.$ = e) && en(e, "frameworkChanged", t.ya);
                  }
                  function fh(e) {
                      try {
                  ...
                  function dh(t) {
                      t.D || t.B.b || (t.B.start(), on(t, "tokenChanged", t.Z), en(t, "tokenChanged", t.Z));
                  }
                  function ph(t) {
                  ...
                  function kh(e, t) {
                      ...
                      e != t &&
                          ...
                          t.metadata ? qi(e, "metadata", new ah((r = t.metadata).a, r.b)) : qi(e, "metadata", new ah()),
                  ...
                  function Nh(t, e) {
                      e[Ga] && t.xa != e[Ga] && (rh(t.b, e), t.dispatchEvent(new $c("tokenChanged")), vh(t, e[Ga]), Ah(t, "refreshToken", t.b.a));
                  }
                  function _h(t, e) {
                  ...
                  function Oh(t, e, n) {
                      return Ki({ user: t, credential: Ro(e), additionalUserInfo: (e = qr(e)), operationType: n });
                  }
                  function Rh(t, e) {
                      return (
                          Nh(t, e),
                  ...
                  function Ch(n, i, t, e, r) {
                      if (!Ei()) return Ee(new I("operation-not-supported-in-this-environment"));
                      if (n.h && !r) return Ee(n.h);
                      var o = Fr(t.providerId),
                          a = Ri(n.uid + ":::"),
                          s = null;
                      (!Si() || li()) && n.s && t.isOAuthProvider && (s = uu(n.s, n.l, n.m, i, t, null, a, Xl.SDK_VERSION || null, null, null, n.tenantId));
                      ...
                      return (
                          (e = e()
                              ...
                              .then(function () {
                                  return new ve(function (t, e) {
                                      n.la(i, null, new I("cancelled-popup-request"), n.g || null), (n.f = t), (n.w = e), (n.g = a), (n.c = Rc(n.i, n, i, u, a));
                                  });
                              })
                              .then(function (t) {
                      ...
                      var i,
                          ...
                          a =
                              ...
                              (i = n).h && !o
                                  ? (r.cancel(), Ee(i.h))
                                  : r.o(function (t) {
                                        throw (!t || ("auth/user-disabled" != t.code && "auth/user-token-expired" != t.code) || (i.h || i.dispatchEvent(new $c("userInvalidated")), (i.h = t)), t);
                                    }));
                      return (
                          n.N.push(a),
                          a.ma(function () {
                          ...
                          a.o(function (t) {
                              var e = null;
                              throw (t && "auth/multi-factor-auth-required" === t.code && (e = Xc(t.v(), fh(n), b(n.hc, n))), e || t);
                          })
                      );
                  }
                  function Mh(t) {
                      ...
                      (n[Ga] = t.stsTokenManager.accessToken), (n.refreshToken = t.stsTokenManager.refreshToken || null);
                      var i = new uh(e, n, t);
                      return (
                          t.providerData &&
                              U(t.providerData, function (t) {
                  ...
                  (Kc.prototype.Pc = function (t) {
                          ...
                          return e.type == Zr
                              ? ((o = this),
                                ...
                                e.Fa().then(function (t) {
                                    return (t = { idToken: t }), void 0 !== s && (t.displayName = s), lt(t, { phoneVerificationInfo: No(o.a) }), Xs(a, Ts, t);
                                }))
                              : ((i = this),
                                (r = t),
                                e.Fa().then(function (t) {
                                    return lt((t = { mfaPendingCredential: t }), { phoneVerificationInfo: No(i.a) }), Xs(r, Es, t);
                                }));
                          var i, r, o, a, s;
                      }),
                      e(Yc, Jc),
                                      ...
                                      .then(function () {
                                          return (
                                              ...
                                              Li() || !e
                                                  ...
                                                  : new ve(function (t) {
                                                        (n = function () {
                                                            Li() && (e.removeEventListener("visibilitychange", n, !1), t());
                                                        }),
                      ...
                      (nh.prototype.v = function () {
                          return { apiKey: this.c.c, refreshToken: this.a, accessToken: this.b && this.b.toString(), expirationTime: ih(this) };
                      }),
                          ...
                          return Lh(
                              ...
                              wh(this)
                                  ...
                                  .then(function (t) {
                                      ...
                                      return t.accessToken != e.xa && (vh(e, t.accessToken), e.dispatchEvent(new $c("tokenChanged"))), Ah(e, "refreshToken", t.refreshToken), t.accessToken;
                                  })
                          );
                      }),
                      (t.Ic = function (t) {
                          ...
                          for (
                              var e =
                                      (i = (i = t).providerUserInfo) && i.length
                                          ? F(i, function (t) {
                                                return new sh(t.rawId, t.providerId, t.email, t.displayName, t.photoUrl, t.phoneNumber);
                                            })
                                          : [],
                                  n = 0;
                              n < e.length;
                              ...
                              Th(this, e[n]);
                          var i;
                          Ah(this, "isAnonymous", !((this.email && t.passwordHash) || (this.providerData && this.providerData.length))), this.dispatchEvent(new $c("userReloaded", { ed: t }));
                      }),
                      (t.Jc = function (t) {
                          return Vi("firebase.User.prototype.reauthenticateAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.reauthenticateWithCredential instead."), this.pb(t);
                      }),
                      (t.pb = function (t) {
                          var e = this,
                              n = null;
                          return Lh(
                              ...
                              t
                                  .c(this.a, this.uid)
                                  .then(function (t) {
                                      return Nh(e, t), (n = Oh(e, t, "reauthenticate")), (e.h = null), e.reload();
                                  })
                                  .then(function () {
                                      return n;
                                  }),
                      ...
                      (t.Ac = function (t) {
                          return Vi("firebase.User.prototype.linkAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.linkWithCredential instead."), this.mb(t);
                      }),
                      (t.mb = function (e) {
                          var n = this,
                              i = null;
                      ...
                      (t.zb = function (e) {
                          if (void 0 === e.displayName && void 0 === e.photoURL) return wh(this);
                          var n = this;
                          return Lh(
                              this,
                              this.I()
                                  .then(function (t) {
                                      return n.a.zb(t, { displayName: e.displayName, photoUrl: e.photoURL });
                                  })
                                  .then(function (t) {
                                      return (
                                          Nh(n, t),
                                          ...
                                          U(n.providerData, function (t) {
                                              "password" === t.providerId && (qi(t, "displayName", n.displayName), qi(t, "photoURL", n.photoURL));
                                          }),
                                          mh(n)
                                      );
                                  })
                      ...
                      (t.ad = function (e) {
                          ...
                          return Lh(
                              ...
                              Sh(this).then(function (t) {
                                  return H(Ih(n), e)
                                      ? Xs(n.a, ys, { idToken: t, deleteProvider: [e] }).then(function (t) {
                                            var e = {};
                                            return (
                      ...
                      (t.delete = function () {
                          ...
                          return Lh(
                              ...
                              ch(e, null), lh(e, null), (e.N = []), (e.D = !0), ph(e), qi(e, "refreshToken", null), e.i && Ac(e.i, e);
                          });
                      }),
                      (t.Cb = function (t, e) {
                          return !!(
                      ...
                      (t.Hb = function (e, n, t, i) {
                          ...
                          return (
                              (t = this.I()
                                  .then(function (t) {
                                      return ls(r.a, { requestUri: e, postBody: i, sessionId: n, idToken: t });
                                  })
                                  .then(function (t) {
                      ...
                      (t.Ib = function (t, e, n, i) {
                          ...
                          return Lh(
                              ...
                              Te()
                                  .then(function () {
                                      return eo(fs(r.a, { requestUri: t, sessionId: e, postBody: i, tenantId: n }), r.uid);
                                  })
                                  .then(function (t) {
                                      return (o = Oh(r, t, "reauthenticate")), Nh(r, t), (r.h = null), r.reload();
                                  })
                                  .then(function () {
                                      return o;
                                  }),
                      ...
                      (t.hc = function (t) {
                          ...
                          return Lh(
                              ...
                              (t = eo(Te(t), n.uid)
                                  .then(function (t) {
                                      return (e = Oh(n, t, "reauthenticate")), Nh(n, t), (n.h = null), n.reload();
                                  })
                                  .then(function () {
                                      return e;
                                  })),
                  ...
                  function Xh(t) {
                      if (((this.l = !1), qi(this, "settings", new Vc()), qi(this, "app", t), !el(this).options || !el(this).options.apiKey)) throw new I("invalid-api-key");
                      var n, e, i, r, o, a, s, u;
                      (t = Xl.SDK_VERSION ? yi(Xl.SDK_VERSION) : null),
                          (this.b = new Ha(el(this).options && el(this).options.apiKey, N(E), t)),
                          (this.P = []),
                          (this.m = []),
                          (this.O = []),
                                          ...
                                          ? ((e.ga = n.B),
                                            n.D && (n.D.fa || null) == (e.fa || null)
                                                ...
                                                : e
                                                      ...
                                                      .o(function (t) {
                                                          return "auth/network-request-failed" == t.code ? e : Gh(n.i);
                                                      }))
                                          : null;
                                  })
                                  .then(function (t) {
                          ...
                          a &&
                              ...
                              (o.Zb = o.Z.then(function () {
                                  if (!o.l) {
                                      if (((o.a = Dc(a, s, el(o).name)), Ec(o.a, o), nl(o) && gh(nl(o)), o.D)) {
                                          gh(o.D);
                                          var t = o.D;
                                          t.va(o.ja()), ch(t, o), hh((t = o.D), o.N), lh(t, o), (o.D = null);
                                      }
                                      return o.a;
                                  }
                              })),
                  ...
                  function Zh(o, a) {
                      ...
                      return (
                          ...
                          o.Z.then(function () {
                              ...
                              .then(function (t) {
                                  return nl(o) && t.uid == nl(o).uid ? kh(nl(o), t) : (Qh(o, t), gh(t)), o.ca(t);
                              })
                              .then(function () {
                                  rl(o);
                              })
                  ...
                  function Qh(t, e) {
                      ...
                      nl(t) &&
                          ...
                          ph(nl(t))),
                          e && (e.R.push(t.Ma), en(e, "tokenChanged", t.xa), en(e, "userDeleted", t.ya), en(e, "userInvalidated", t.za), 0 < t.s && dh(e)),
                          qi(t, "currentUser", e),
                      ...
                      return ol(
                          ...
                          t
                              .then(
                                  ...
                                  function (t) {
                                      var e = null;
                                      throw (t && "auth/multi-factor-auth-required" === t.code && (e = Xc(t.v(), n, b(n.ic, n))), e || t);
                                  }
                              )
                              .then(function () {
                                  return Ki({ user: nl(n), credential: e, additionalUserInfo: i, operationType: "signIn" });
                              })
                      );
                  }
                  function el(t) {
                  ...
                  function rl(t) {
                      if (t.aa) {
                          ...
                          if (t.W !== t.getUid() && t.O.length) for (t.W = t.getUid(), e = 0; e < t.O.length; e++) t.O[e] && t.O[e](il(t));
                      }
                  }
                  function ol(t, e) {
                      return (
                  ...
                  (Vh.prototype.tb = function (e) {
                      ...
                      (t.va = function (t) {
                          this.$ === t || this.l || ((this.$ = t), Ya(this.b, this.$), this.dispatchEvent(new Jh(this.ja())));
                      }),
                      (t.ja = function () {
                          return this.$;
                      }),
                      ...
                      (t.Ec = function (t) {
                          this.N.push(t), za(this.b, Xl.SDK_VERSION ? yi(Xl.SDK_VERSION, this.N) : null), this.dispatchEvent(new Yh(this.N));
                      }),
                      (t.Ea = function () {
                          return W(this.N);
                      }),
                      ...
                      (t.toJSON = function () {
                          return { apiKey: el(this).options.apiKey, authDomain: el(this).options.authDomain, appName: el(this).name, currentUser: nl(this) && nl(this).v() };
                      }),
                      (t.Cb = function (t, e) {
                          switch (t) {
                              case "unknown":
                      ...
                      (t.Vc = function (e) {
                          ...
                          (!Si() || li()) &&
                              ...
                              e.isOAuthProvider &&
                              (r = uu(el(this).options.authDomain, el(this).options.apiKey, el(this).name, "signInViaPopup", e, null, i, Xl.SDK_VERSION || null, null, null, this.S()));
                          ...
                          return ol(
                              ...
                              (t = zh(this)
                                  ...
                                  .then(function () {
                                      return new ve(function (t, e) {
                                          n.la("signInViaPopup", null, new I("cancelled-popup-request"), n.g), (n.f = t), (n.w = e), (n.g = i), (n.c = Rc(n.a, n, "signInViaPopup", o, i));
                                      });
                                  })
                                  .then(function (t) {
                      ...
                      (t.bd = function (t) {
                          ...
                          var e = this,
                              n = {};
                          (n.apiKey = el(this).options.apiKey), (n.authDomain = el(this).options.authDomain), (n.appName = el(this).name);
                          var i,
                              r,
                              o,
                              a,
                              ...
                              c =
                                  ...
                                  (u.refreshToken = s.a),
                                  (r = new uh(r || { apiKey: i.l, authDomain: i.s, appName: i.m }, u)),
                                  o && (r.ga = o),
                                  a && hh(r, a),
                                  kh(r, i),
                                  r);
                          return ol(
                              ...
                              this.h
                                  ...
                                  .then(function () {
                                      return nl(e) && t.uid == nl(e).uid ? (kh(nl(e), t), e.ca(t)) : (Qh(e, c), gh(c), e.ca(c));
                                  })
                                  .then(function () {
                                      rl(e);
                                  })
                      ...
                      (t.Xc = function () {
                          ...
                          return Bh(this.i, el(this).options.authDomain).then(function (t) {
                              if (!i.l) {
                                  ...
                                  (nl(i) || t) && (Qh(i, t), t && (gh(t), (t.ga = i.B)), i.a && Ec(i.a, i), rl(i));
                              }
                          });
                      }),
                      (t.ca = function (t) {
                      ...
                      (t.yc = function (t) {
                          ...
                          (n = function () {
                              ...
                              ol(
                                  e,
                                  e.h.then(function () {
                                      !e.l && H(e.O, n) && e.W !== e.getUid() && ((e.W = e.getUid()), n(il(e)));
                                  })
                              );
                      }),
                      (t.Gc = function (t, e, n) {
                      ...
                      (t.Fc = function (t, e, n) {
                          ...
                          return (
                              this.aa &&
                                  Promise.resolve().then(function () {
                                      (i.W = i.getUid()), p(t) ? t(nl(i)) : p(t.next) && t.next(nl(i));
                                  }),
                              this.ac(t, e, n)
                          );
                      }),
                      ...
                      (t.Qc = function (t) {
                          return Vi("firebase.auth.Auth.prototype.signInAndRetrieveDataWithCredential is deprecated. Please use firebase.auth.Auth.prototype.signInWithCredential instead."), this.Ya(t);
                      }),
                      (t.vb = function () {
                          var n = this;
                          return this.h.then(function () {
                              ...
                              if (t && t.isAnonymous) {
                                  ...
                                  return Ki({ user: t, credential: null, additionalUserInfo: e, operationType: "signIn" });
                              }
                      ...
                      (t.bc = function (t) {
                          this.addAuthTokenListener(t), this.s++, 0 < this.s && nl(this) && dh(nl(this));
                      }),
                      (t.Nc = function (e) {
                          var n = this;
                          U(this.m, function (t) {
                      ...
                      (t.delete = function () {
                          ...
                          return (this.P = []), this.i && (t = this.i).b.removeListener(Hh("local"), t.a, this.oa), this.a && (Ac(this.a, this), Mc(this.a.b)), Promise.resolve();
                      }),
                      (t.fc = function (t) {
                          return ol(
                              this,
                              Xs(this.b, gs, { identifier: t, continueUri: Ai() ? ni() : "http://localhost" }).then(function (t) {
                      ...
                      (t.sb = function (e, n) {
                          ...
                          return ol(
                              ...
                              Te()
                                  .then(function () {
                                      var t = new Ir(n);
                                      if (!t.c) throw new I("argument-error", Ar + " must be true when sending sign in link to email");
                                      return Cr(t);
                                  })
                                  .then(function (t) {
                                      return i.b.sb(e, t);
                      ...
                      (t.Tc = function (n, i) {
                          ...
                          return ol(
                              ...
                              Te().then(function () {
                                  var t = i || ni(),
                                      e = Eo(n, t);
                                  if (!(t = Ao(t))) throw new I("argument-error", "Invalid email link!");
                  ...
                  (sl.prototype.render = function (t, e) {
                      ...
                      (ll.prototype.delete = function () {
                          fl(this), (this.g = !0), clearTimeout(this.a), (this.a = null), on(this.f, "click", this.i);
                      }),
                  ...
                  var gl = new dt(mt, "https://www.google.com/recaptcha/api.js?onload=%{onload}&render=explicit&hl=%{hl}"),
                      bl = new Pi(3e4, 6e4);
                  ...
                  function wl(t, e, n, i, r, o, a) {
                      if (
                          ...
                          throw new I("argument-error", "sitekey should not be provided for reCAPTCHA as one is automatically provisioned for the current project.");
                      if (((this.i = "invisible" === this.a[Al]), !l.document)) throw new I("operation-not-supported-in-this-environment", "RecaptchaVerifier is only supported in a browser HTTP/HTTPS environment with DOM support.");
                          ...
                          if (((o = e.length), n.length < r || o < n.length)) i = "Expected " + (r == o ? (1 == r ? "1 argument" : r + " arguments") : r + "-" + o + " arguments") + " but got " + n.length + ".";
                              ...
                              for (r = 0; r < n.length; r++)
                                  if (((o = e[r].optional && void 0 === n[r]), !e[r].K(n[r]) && !o)) {
                                      if (((e = e[r]), r < 0 || r >= Rl.length)) throw new I("internal-error", "Argument validator received an unsupported number of arguments.");
                                      (n = Rl[r]), (i = (i ? "" : n + " argument ") + (e.name ? '"' + e.name + '" ' : "") + "must be " + e.J + ".");
                                      break t;
                                  }
                              i = null;
                          }
                  ...
                  Kl(Xh.prototype, {
                      ...
                      jb: { name: "confirmPasswordReset", j: [Cl("code"), Cl("newPassword")] },
                      cc: { name: "createUserWithEmailAndPassword", j: [Cl("email"), Cl("password")] },
                      fc: { name: "fetchSignInMethodsForEmail", j: [Cl("email")] },
                      pa: { name: "getRedirectResult", j: [] },
                      zc: { name: "isSignInWithEmailLink", j: [Cl("emailLink")] },
                      Fc: { name: "onAuthStateChanged", j: [Hl(Pl(), Ll(), "nextOrObserver"), Ll("opt_error", !0), Ll("opt_completed", !0)] },
                      Gc: { name: "onIdTokenChanged", j: [Hl(Pl(), Ll(), "nextOrObserver"), Ll("opt_error", !0), Ll("opt_completed", !0)] },
                      rb: { name: "sendPasswordResetEmail", j: [Cl("email"), Hl(Pl("opt_actionCodeSettings", !0), Ml(null, !0), "opt_actionCodeSettings", !0)] },
                      sb: { name: "sendSignInLinkToEmail", j: [Cl("email"), Pl("actionCodeSettings")] },
                      ...
                      Sc: { name: "signInWithEmailAndPassword", j: [Cl("email"), Cl("password")] },
                      Tc: { name: "signInWithEmailLink", j: [Cl("email"), Cl("emailLink", !0)] },
                      ...
                      Gl(Xh.prototype, { lc: { name: "languageCode", gb: Hl(Cl(), Ml(), "languageCode") }, ti: { name: "tenantId", gb: Hl(Cl(), Ml(), "tenantId") } }),
                      ...
                      Kl(uh.prototype, {
                          ...
                          Kc: { name: "reauthenticateWithPhoneNumber", j: [Cl("phoneNumber"), ql()] },
                          Lc: { name: "reauthenticateWithPopup", j: [Ul()] },
                          Mc: { name: "reauthenticateWithRedirect", j: [Ul()] },
                          reload: { name: "reload", j: [] },
                          qb: { name: "sendEmailVerification", j: [Hl(Pl("opt_actionCodeSettings", !0), Ml(null, !0), "opt_actionCodeSettings", !0)] },
                          toJSON: { name: "toJSON", j: [Cl(null, !0)] },
                          ...
                          Ab: { name: "verifyBeforeUpdateEmail", j: [Cl("email"), Hl(Pl("opt_actionCodeSettings", !0), Ml(null, !0), "opt_actionCodeSettings", !0)] },
                      }),
                      Kl(sl.prototype, { execute: { name: "execute" }, render: { name: "render" }, reset: { name: "reset" }, getResponse: { name: "getResponse" } }),
                      Kl(al.prototype, { execute: { name: "execute" }, render: { name: "render" }, reset: { name: "reset" }, getResponse: { name: "getResponse" } }),
                      Kl(ve.prototype, { ma: { name: "finally" }, o: { name: "catch" }, then: { name: "then" } }),
                      Gl(Vc.prototype, { appVerificationDisabled: { name: "appVerificationDisabledForTesting", gb: Dl("appVerificationDisabledForTesting") } }),
                      Kl(Fc.prototype, { confirm: { name: "confirm", j: [Cl("verificationCode")] } }),
                      Bl(
                          to,
                          "fromJSON",
                          function (t) {
                              t = "string" == typeof t ? JSON.parse(t) : t;
                              for (var e, n = [so, Io, So, ro], i = 0; i < n.length; i++) if ((e = n[i](t))) return e;
                              return null;
                          },
                          [Hl(Cl(), Pl(), "json")]
                      ),
                      ...
                      Kl(lo.prototype, { Aa: { name: "addScope", j: [Cl("scope")] }, Ia: { name: "setCustomParameters", j: [Pl("customOAuthParameters")] } }),
                      Bl(lo, "credential", fo, [Hl(Cl(), Pl(), "token")]),
                      Bl(To, "credentialWithLink", Eo, [Cl("email"), Cl("emailLink")]),
                      Kl(po.prototype, { Aa: { name: "addScope", j: [Cl("scope")] }, Ia: { name: "setCustomParameters", j: [Pl("customOAuthParameters")] } }),
                      Bl(po, "credential", vo, [Hl(Cl(), Pl(), "token")]),
                      Kl(mo.prototype, { Aa: { name: "addScope", j: [Cl("scope")] }, Ia: { name: "setCustomParameters", j: [Pl("customOAuthParameters")] } }),
                      Bl(mo, "credential", go, [Hl(Cl(), Hl(Pl(), Ml()), "idToken"), Hl(Cl(), Ml(), "accessToken", !0)]),
                      Kl(bo.prototype, { Ia: { name: "setCustomParameters", j: [Pl("customOAuthParameters")] } }),
                      Bl(bo, "credential", yo, [Hl(Cl(), Pl(), "token"), Cl("secret", !0)]),
                      Kl(ho.prototype, {
                          Aa: { name: "addScope", j: [Cl("scope")] },
                          credential: { name: "credential", j: [Hl(Cl(), Hl(Pl(), Ml()), "optionsOrIdToken"), Hl(Cl(), Ml(), "accessToken", !0)] },
                          Ia: { name: "setCustomParameters", j: [Pl("customOAuthParameters")] },
                      }),
                      Kl(oo.prototype, { v: { name: "toJSON", j: [Cl(null, !0)] } }),
                      Kl(no.prototype, { v: { name: "toJSON", j: [Cl(null, !0)] } }),
                      Bl(_o, "credential", Oo, [Cl("verificationId"), Cl("verificationCode")]),
                      Kl(_o.prototype, {
                          cb: {
                                          ...
                                          K: function (t) {
                                              return (
                                                  ...
                                                  (t.session && t.phoneNumber
                                                      ? Vl(t.session, Zr) && "string" == typeof t.phoneNumber
                                                      : t.session && t.multiFactorHint
                                                      ? Vl(t.session, Qr) && Fl(t.multiFactorHint)
                                                      : t.session && t.multiFactorUid
                                                      ? Vl(t.session, Qr) && "string" == typeof t.multiFactorUid
                      ...
                      Kl(Zc.prototype, {
                          ...
                          $c: { name: "unenroll", j: [Hl({ name: "multiFactorInfo", J: "a valid multiFactorInfo", optional: !1, K: Fl }, Cl(), "multiFactorInfoIdentifier")] },
                      }),
                      Kl(_l.prototype, { clear: { name: "clear", j: [] }, render: { name: "render", j: [] }, verify: { name: "verify", j: [] } }),
                      ...
                      (function () {
                          if (void 0 === Xl || !Xl.INTERNAL || !Xl.INTERNAL.registerComponent) throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library.");
                          var t = {
                              ActionCodeInfo: {
                                  Operation: { EMAIL_SIGNIN: tr, PASSWORD_RESET: "PASSWORD_RESET", RECOVER_EMAIL: "RECOVER_EMAIL", REVERT_SECOND_FACTOR_ADDITION: Qi, VERIFY_AND_CHANGE_EMAIL: er, VERIFY_EMAIL: "VERIFY_EMAIL" },
                              },
                              Auth: Xh,
                              AuthCredential: to,
                              Error: I,
                          ...
                          Bl(t, "EmailAuthProvider", To, []),
                              ...
                              Xl.INTERNAL.registerComponent({
                                  name: "auth-internal",
                                  instanceFactory: function (t) {
                                      return { getUid: b((t = t.getProvider("auth").getImmediate()).getUid, t), getToken: b(t.kc, t), addAuthTokenListener: b(t.bc, t), removeAuthTokenListener: b(t.Nc, t) };
                                  },
                                  multipleInstances: !1,
                                  instantiationMode: "LAZY",
                                  type: "PRIVATE",
                              }),
                              Xl.registerVersion("@firebase/auth", "0.14.5"),
