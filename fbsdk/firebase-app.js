!(function (e, t) {
  ...
  var o,
      s,
      c,
      h = ((o = Error), r((s = u), (c = o)), (s.prototype = null === c ? Object.create(c) : ((l.prototype = c.prototype), new l())), u);
  function l() {
      this.constructor = s;
  }
  function u(e, t) {
  ...
  var f =
      ((y.prototype.create = function (e) {
          ...
          for (
              ...
              var f = u[p];
              "_" !== f.slice(-1) && (f in l && console.warn('Overwriting FirebaseError base field "' + f + '" can cause unexpected behavior.'), (l[f] = i[f]));
          }
          return l;
      }),
      y);
  ...
  var x,
      H = { debug: C.DEBUG, verbose: C.VERBOSE, info: C.INFO, warn: C.WARN, error: C.ERROR, silent: C.SILENT },
      T = C.INFO,
  ...
  var M,
      ...
      Z =
          ...
          (q.prototype._getService = function (e, t) {
              return void 0 === t && (t = Y), this.checkDestroyed_(), this.container.getProvider(e).getImmediate({ identifier: t });
          }),
          ...
          (q.prototype.checkDestroyed_ = function () {
              if (this.isDeleted_) throw G.create("app-deleted", { appName: this.name_ });
          }),
          q);
  function q(e, t, r) {
      var n,
  ...
  function X(c) {
      var l = {},
          ...
          u = {
              ...
              initializeApp: function (e, t) {
                  ...
                  var n = r.name;
                  if ("string" != typeof n || !n) throw G.create("bad-app-name", { appName: String(n) });
              ...
              registerVersion: function (e, t, r) {
                  ...
                  if (o || a) {
                      ...
                      return (
                          o && s.push('library name "' + i + '" contains illegal characters (whitespace or "/")'),
                          o && a && s.push("and"),
              ...
              setLogLevel: U,
              onLog: function (e, t) {
                  if (null !== e && "function" != typeof e) throw G.create("invalid-log-argument", { appName: name });
                  !(function (a, t) {
                      for (
                          var e = function (e) {
                                  var o = null;
                                          ...
                                          null === a
                                              ...
                                              : function (e, t) {
                                                    ...
                                                    var i = r
                                                        ...
                                                        .join(" ");
                                                    t >= (null != o ? o : e.logLevel) && a({ level: C[t].toLowerCase(), message: i, args: r, type: e.name });
                                                });
                              },
                              r = 0,
                              n = F;
      ...
      function h(r) {
          ...
          if ((p.set(n, r), "PUBLIC" === r.type)) {
              var i = function (e) {
                  if ((void 0 === e && (e = f()), "function" != typeof e[n])) throw G.create("invalid-app-argument", { appName: n });
                  return e[n]();
              };
  ...
  (oe = se).INTERNAL.registerComponent(
      ...
      oe.registerVersion($, "0.6.3", ae),
      oe.registerVersion("fire-js", "");
  return se.registerVersion("firebase", "7.14.4", "app"), se;
});
